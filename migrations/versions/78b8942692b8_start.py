...
Revision ID: 78b8942692b8
Revises: 
Create Date: 2021-04-03 20:56:34.530030
...
def upgrade():
    ...
    sa.Column('dates', sa.String(length=256), nullable=True),
    sa.ForeignKeyConstraint(['program_id'], ['program.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['user.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_interview_date'), 'interview', ['date'], unique=False)
    op.create_index(op.f('ix_interview_dates'), 'interview', ['dates'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_interview_dates'), table_name='interview')
