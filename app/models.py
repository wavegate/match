...
class User(UserMixin, db.Model):
	...
	postiv_communications = db.relationship('PostInterviewCommunication', backref='author', lazy='dynamic')
...
class Program(db.Model):
	...
	postiv_communications = db.relationship('PostInterviewCommunication', backref='program', lazy='dynamic')
	language = db.Column(db.String(5))
...
class PostInterviewCommunication(db.Model):
	id = db.Column(db.Integer, primary_key=True)
	user_id = db.Column(db.Integer, db.ForeignKey('user.id'))
	timestamp = db.Column(db.DateTime, index=True, default=datetime.utcnow)
	date_of_communication = db.Column(db.DateTime, index=True)
	type_of_communication = db.Column(db.String(500))
